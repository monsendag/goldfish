 ...
 */
public final class SMItemPreferenceArray implements SMPreferenceArray {
  ...
  private final class PreferenceView extends SMPreference {
    ...
    public long getUserID() {
      return SMItemPreferenceArray.this.getUserID(i);
    }

    public long getItemID() {
      return SMItemPreferenceArray.this.getItemID(i);
    }
